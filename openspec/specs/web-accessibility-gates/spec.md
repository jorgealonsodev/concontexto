# Spec: web-accessibility-gates

Baseline capability specification — the source of truth for `web-accessibility-gates`.

Sources: PRD §12.5, §12.3, §13, §14.2.
...
apparatus: it turns each accessibility and budget claim made elsewhere into a blocking gate.
